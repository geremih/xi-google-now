...
public class SetupActivity extends ActionBarActivity {
    ...
    public static class AccessibilityFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (MyAccessibilityService.isAccessibilitySettingsOn(getActivity())) {
                instructions.setText("Accessibility already configured");
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            if (requestCode == 2) {
                ...
                if (MyAccessibilityService.isAccessibilitySettingsOn(getActivity())) {
                    ...
                    instructions.setText("Accessibility configured");
                    openSettings.setVisibility(View.GONE);
                    limited.setVisibility(View.GONE);
                    done.setVisibility(View.VISIBLE);
    ...
    public static class IntentFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (checkIfDefault()) {
                instructions.setText("Default already set");
                ...
                if (count < 2) {
                    instructions.setText("Dialog hidden");
                    openDialog.setVisibility(View.GONE);
                    divider.setVisibility(View.GONE);
                    swipeLeft.setVisibility(View.VISIBLE);
                }
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            if (requestCode == 1) {
                ...
                if (checkIfDefault()) {
                    ...
                    instructions.setText("Default set successfully");
                    openDialog.setVisibility(View.GONE);
                    swipeLeft.setVisibility(View.VISIBLE);
                    divider.setVisibility(View.GONE);
                }
        ...
        private boolean checkIfDefault() {
            ...
            try {
                ...
                return mInfo.activityInfo.packageName.equals("googlenow.xi.org.xi_google_now");
            } catch (Exception e) {
                return false;
            }
        }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            testInput.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable editable) {
                    if (editable.toString().toLowerCase().trim().equals("note to self pause music")) {
                        ...
                        if (editable.toString().toLowerCase().trim().equals("pause music")) {
                            testInput.setError("Remember to put \"Note to Self\" first!");
                        }
                        if (editable.toString().contains(",") || editable.toString().contains("\"") || editable.toString().contains(".")) {
                            testInput.setError("No punctuation");
                        }
                    }
                }
            });
